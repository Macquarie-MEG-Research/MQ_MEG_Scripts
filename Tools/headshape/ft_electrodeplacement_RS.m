function [elec] = ft_electrodeplacement_RS(cfg, varargin)
...
%
% This is a modified version of the original ft_electrodeplacement function
% by Robert Seymour (robert.seymour@mq.ed.au), with small modifications for
% the mq_3D_coreg function.
%
